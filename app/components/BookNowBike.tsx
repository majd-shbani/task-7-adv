...
const BookNowBike = () => {
    ...
    return (
        <div className="relative h-225 sm:h-200 lg:h-full flex flex-col items-center lg:items-start px-5 lg:px-10 2xl:px-whiteSpacing py-7 2xl:py-15 mt-15.75 ">
            <div className="lg:w-[48%] max-w-183.5">
            ...
            className="max-w-75 sm:max-w-124 2xl:w-[35%] 2xl:max-w-max absolute -bottom-5.5 right-[50%] translate-x-1/2 lg:translate-x-0 lg:right-10 2xl:right-whiteSpacing"/>
